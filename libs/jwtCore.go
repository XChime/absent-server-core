...
func NewTokenWithTime(data interface{}) (bool, string) {
...
func VerifyTokenGeneric(token string, inter interface{}) (bool, interface{}, string) {
	...
	if err != nil {
		if err == jwt.ErrSignatureInvalid {
			return false, inter, err.Error()
		}
		return false, inter, err.Error()
	}
	if !tkn.Valid {
		return false, inter, "INVALID TOKEN"
	}
